...
sed -e "s/'database' => 'preg'/'database' => '$sigla'/g" \
    -e "s/'username' => 'root'/'username' => '$sigla'/g" \
    -e "s/'password' => ''/'password' => '$senha'/g" ww2.preg.ufrpe.br/settings.php > $dominio/settings.php
